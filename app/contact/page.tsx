...
export const metadata = pageMeta({
  ...
  description:
    '横浜の訪問介護 株式会社はるじゅへのお問い合わせページです。訪問介護・障害福祉サービス・移動支援・保険外サービスのご利用に関するご相談、採用に関するご相談を受け付けています。ご家族やケアマネジャーの方からのお問い合わせも承っています。',
  path: '/contact',
          ...
          <Reveal>
            <div className="flex h-full flex-col rounded-3xl border border-paper-200 bg-white p-7">
              ...
              <p className="mt-3 text-[14px] leading-relaxed text-ink-700">
                訪問介護・障害福祉サービス・移動支援・保険外サービスのご利用について。「何から始めればよいか分からない」
