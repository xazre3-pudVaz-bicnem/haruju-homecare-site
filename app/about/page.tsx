...
export const metadata = pageMeta({
  ...
  description:
    '横浜市内で訪問介護・障害福祉サービス・移動支援・保険外サービスを行う株式会社はるじゅの理念をご紹介します。その人らしい暮らしを尊重し、ご家族の不安に寄り添い、ケアマネジャー・医療・行政と連携して在宅生活を支えます。',
  path: '/about',
        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
          ...
          <Reveal delay={80}>
            ...
            <div className="mt-6">
              <LeadParagraphs
                paragraphs={[
                  'はるじゅは、横浜市内を中心に訪問介護・障害福祉サービス・移動支援・保険外サービスを行う地域密着の介護事業所です。ホームヘルパーがご自宅にうかがい、身体介護と生活援助の両面から在宅での暮らしをお手伝いします。',
