...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPaths: {
    ...
    { path: '/service/disability-home-care', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/service/accompanying-support', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/service/behavioral-support', priority: 0.8, changeFrequency: 'monthly' },
    { path: '/service/mobility-support', priority: 0.8, changeFrequency: 'monthly' },
